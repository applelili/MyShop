...
import com.example.administrator.myshopliang.base.utils.LogUtils;
...
import com.example.administrator.myshopliang.network.entity.Paginated;
...
import com.example.administrator.myshopliang.widgets.banner.SimpleSearchView;
...
public class SearchGoodsActivity extends BaseActivity {
    ...
    public void goodsItemClick(int position){
        //  跳转到详情页
        id =  mGoodsAdapter.getItem(position).getId();
        intent = GoodsActivity.getStartIntent(this, id);
